...
public class GradleNewDeterminLetterTest {
    ...
    private char determinLetter(int numGrade) {
        if (numGrade < 0) {
            ...
            // This condition is redundant and incorrectly placed, leading to unreachable code and logical errors.
            // Commenting out the following line to prevent confusion and errors in logic.
            // return 'F';
        }
        return 'O';
    }
